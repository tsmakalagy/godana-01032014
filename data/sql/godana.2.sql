...
--
-- Host: localhost
-- Generation Time: Mar 03, 2014 at 11:50 AM
...
DROP TABLE IF EXISTS `gdn_attribute`;
CREATE TABLE `gdn_attribute` (
...
DROP TABLE IF EXISTS `gdn_bid`;
CREATE TABLE `gdn_bid` (
...
DROP TABLE IF EXISTS `gdn_car`;
CREATE TABLE `gdn_car` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `gdn_car_driver`;
CREATE TABLE `gdn_car_driver` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `cooperative_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `gdn_car_file`;
CREATE TABLE `gdn_car_file` (
...
DROP TABLE IF EXISTS `gdn_car_make`;
CREATE TABLE `gdn_car_make` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `gdn_car_model`;
CREATE TABLE `gdn_car_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `gdn_contact`;
CREATE TABLE `gdn_contact` (
...
DROP TABLE IF EXISTS `gdn_contact_type`;
CREATE TABLE `gdn_contact_type` (
...
DROP TABLE IF EXISTS `gdn_cooperative`;
CREATE TABLE `gdn_cooperative` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `gdn_cooperative` (`id`, `name`, `description`) VALUES
(1, 'Mami', NULL),
(2, 'Vatsi', NULL),
(3, 'Besady', NULL),
(4, 'Cotisse', NULL),
...
DROP TABLE IF EXISTS `gdn_cooperative_admin`;
CREATE TABLE `gdn_cooperative_admin` (
...
DROP TABLE IF EXISTS `gdn_cooperative_contact`;
CREATE TABLE `gdn_cooperative_contact` (
  `cooperative_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_cooperative_line`;
CREATE TABLE `gdn_cooperative_line` (
  `cooperative_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_cooperative_line_contact`;
CREATE TABLE `gdn_cooperative_line_contact` (
...
DROP TABLE IF EXISTS `gdn_cooperative_teller`;
CREATE TABLE `gdn_cooperative_teller` (
  `cooperative_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_cooperative_zone`;
CREATE TABLE `gdn_cooperative_zone` (
  `cooperative_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_driver_contact`;
CREATE TABLE `gdn_driver_contact` (
...
DROP TABLE IF EXISTS `gdn_feed`;
CREATE TABLE `gdn_feed` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `post_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
(111, 'image/jpeg', 'http://localhost.godana/files/shops/cover/6/5dbd846fa6.jpg', '5dbd846fa6.jpg', 53108, NULL, NULL),
(112, 'image/jpeg', 'http://localhost.godana/files/shops/cover/1/cb72348bd0.jpg', 'cb72348bd0.jpg', 195191, NULL, NULL),
(113, 'image/jpeg', 'http://localhost.godana/files/shops/cover/1/c06747c183.jpg', 'c06747c183.jpg', 1532026, NULL, NULL),
(114, 'image/jpeg', 'http://localhost.godana/files/shops/cover/1/0f2d3c51e2.jpg', '0f2d3c51e2.jpg', 302360, NULL, NULL);
...
DROP TABLE IF EXISTS `gdn_image`;
CREATE TABLE `gdn_image` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(28, 111, 'sm', '5dbd846fa6.jpg_w400_cx0_cy46_cw580_ch257.jpg'),
(29, 111, 'md', '5dbd846fa6.jpg_w900_cx0_cy46_cw580_ch257.jpg'),
(30, 112, 'sm', 'cb72348bd0.jpg_w400_cx0_cy28_cw1600_ch711.jpg'),
(31, 112, 'md', 'cb72348bd0.jpg_w900_cx0_cy28_cw1600_ch711.jpg'),
(32, 113, 'sm', 'c06747c183.jpg_w400_cx0_cy591_cw1920_ch533.jpg'),
(33, 113, 'md', 'c06747c183.jpg_w900_cx0_cy591_cw1920_ch533.jpg'),
(36, 114, 'sm', '0f2d3c51e2.jpg_w400_cx0_cy535_cw1600_ch341.jpg'),
(37, 114, 'md', '0f2d3c51e2.jpg_w1170_cx0_cy535_cw1600_ch341.jpg');
...
DROP TABLE IF EXISTS `gdn_line`;
CREATE TABLE `gdn_line` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `gdn_line_car`;
CREATE TABLE `gdn_line_car` (
  `line_id` int(11) NOT NULL,
  `car_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_line_contact`;
CREATE TABLE `gdn_line_contact` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `cooperative_id` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `gdn_passenger`;
CREATE TABLE `gdn_passenger` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `gdn_passenger_contact`;
CREATE TABLE `gdn_passenger_contact` (
...
DROP TABLE IF EXISTS `gdn_post`;
CREATE TABLE `gdn_post` (
...
DROP TABLE IF EXISTS `gdn_post_category`;
CREATE TABLE `gdn_post_category` (
...
DROP TABLE IF EXISTS `gdn_post_contact`;
CREATE TABLE `gdn_post_contact` (
  `post_id` int(11) NOT NULL,
  `contact_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_post_file`;
CREATE TABLE `gdn_post_file` (
...
DROP TABLE IF EXISTS `gdn_post_tag`;
CREATE TABLE `gdn_post_tag` (
  `post_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_product`;
CREATE TABLE `gdn_product` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `gdn_product` (`id`, `type_id`, `name`, `description`, `price`, `measurement`, `shop_id`, `is_deleted`, `date_created`) VALUES
(1, 1, 'tennis', '', 100000, 1, 1, 0, '2013-12-11 00:00:00'),
(2, 1, 'tennis', '', 100000, 1, 1, 0, '2013-06-16 00:00:00'),
(3, 3, 'tennis', '', 100000, 1, 1, 0, '2013-06-18 00:00:00'),
(4, 1, 'tbs', 'chaussure de rue', 100000, 10, 2, 0, '2013-12-24 00:00:00'),
(5, 5, 'huile sae 40', 'Huile moteur diesel', 10000, 1, 2, 0, '2014-02-09 00:00:00'),
(6, 1, 'chaussure de rue', '', 10000, 1, 1, 0, '2013-10-03 00:00:00'),
(7, 2, 'pantalon jeans', 'Jean', 15000, 5, 1, 0, '2013-11-18 00:00:00'),
(8, 2, 'pantalon jeans femme', 'Jeans', 15000, 5, 1, 0, '2014-01-08 00:00:00'),
(9, 1, 'chaussure bateau', 'bateau', 25000, 4, 1, 0, '2014-03-03 00:00:00'),
(10, 1, 'basket air jordan', 'Air Jordan 3', 100000, 5, 1, 0, '2014-03-03 09:29:24'),
(11, 5, 'huile sae 90', 'Huile moteur diesel SAE 90', 40000, 5, 3, 0, '2014-03-03 09:38:44');
...
DROP TABLE IF EXISTS `gdn_producttype_attribute`;
CREATE TABLE `gdn_producttype_attribute` (
...
DROP TABLE IF EXISTS `gdn_product_attribute`;
CREATE TABLE `gdn_product_attribute` (
...
DROP TABLE IF EXISTS `gdn_product_file`;
CREATE TABLE `gdn_product_file` (
...
DROP TABLE IF EXISTS `gdn_product_type`;
CREATE TABLE `gdn_product_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `gdn_reservation`;
CREATE TABLE `gdn_reservation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `gdn_reservation_board`;
CREATE TABLE `gdn_reservation_board` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `gdn_shop`;
CREATE TABLE `gdn_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 1, 'Avance center', 'avance-center', 'Magasin d''habillement, de mode et de parfum. Tous nos produits sont import̩s de Bangkok Thailand.', 0, 114),
(2, 3, 'Avance center', 'avance-center', NULL, 1, NULL),
(3, 1, 'Japan actuel', 'japan-actuel', '', 0, NULL),
...
(6, 3, 'Ramji Transport', 'ramji-transport', 'Transport de marchandise', 0, 111),
...
(9, 1, 'Lewis', 'lewis', 'Charcuterie et boucherie', 0, NULL);
...
DROP TABLE IF EXISTS `gdn_shop_category`;
CREATE TABLE `gdn_shop_category` (
...
DROP TABLE IF EXISTS `gdn_shop_city`;
CREATE TABLE `gdn_shop_city` (
  `shop_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_shop_contact`;
CREATE TABLE `gdn_shop_contact` (
  `shop_id` int(11) NOT NULL,
  `contact_id` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `gdn_zone`;
CREATE TABLE `gdn_zone` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
