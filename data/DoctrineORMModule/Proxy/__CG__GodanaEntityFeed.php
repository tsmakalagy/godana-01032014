 ...
 */
class Feed extends \Godana\Entity\Feed implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'post', 'comments');
        }
     ...
     * {@inheritDoc}
     */
    public function setPost(\Godana\Entity\Post $post)
    {
