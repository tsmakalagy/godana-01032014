 ...
 */
class ProductType extends \Godana\Entity\ProductType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'unit', 'attributes');
        }
     ...
     * {@inheritDoc}
     */
    public function addAttribute(\Godana\Entity\Attribute $attribute)
    {
